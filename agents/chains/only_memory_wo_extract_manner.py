...
class OnlyMemoryChainWithoutMannerExtract(BaseChain):
    ...
    def __init__(self):
        ...
        edge_list = [
            (nodes.QuestionDecompositionNode, nodes.GetMannerFromMemoryNode),
        ...
        # self.set_entry_point(nodes.GetMannerFromMemoryNode().get_name())
